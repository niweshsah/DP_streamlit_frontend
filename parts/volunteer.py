...
def validate_csv_data(df: pd.DataFrame) -> Tuple[bool, str]:
    ...
    try:
        ...
        required_columns = ["name", "email", "event_code", "location", "start_time", "end_time"]
    ...
    try:
        ...
        for attendee in attendees:
            try:
                ...
                # start_time = datetime.strptime(attendee["start_time"], "%Y-%m-%d %H:%M:%S")
                start_time = attendee["start_time"]
                end_time = attendee["end_time"]
                # end_time = datetime.strptime(attendee["end_time"], "%Y-%m-%d %H:%M:%S")
                location = attendee["location"]
                event_code = attendee["event_code"]
