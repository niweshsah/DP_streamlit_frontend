...
# def check_group_exists(group_number):
#     """
#     Check if a group already exists
    
#     Args:
#         group_number (str): The group number to check
...
#             return True  # Prevent submission on unexpected errors
    
#     except requests.exceptions.RequestException as e:
#         st.error(f"Error checking group existence: {e}")
#         return True  # Prevent submission on network errors

# def main_group():
#     st.title("Group Management with Email Verification")
#     st.header("Add Group Details and Verify Email")
...
#     faculty_members = [st.text_input(f"Faculty {i+1} Name") for i in range(num_faculty)]
...
#     email = st.text_input("Enter Your Email for Verification")
...
#                         "otp": str(otp),  # Explicitly store as string
...
#             st.markdown('<p style="color:green;">✅ Email Verified</p>', unsafe_allow_html=True)
#         else:
#             st.markdown('<p style="color:orange;">⏳ Verification Pending</p>', unsafe_allow_html=True)

#     # Submit Group Details
#     if st.button("Submit Group Details"):
#         # Validate email verification
#         if email not in st.session_state.otp_storage or not st.session_state.otp_storage[email].get("verified", False):
...
#         if check_group_exists(group_no):
#             return  # Stop submission if group exists
...
# st.set_page_config(page_title="GatherHub Group Management", page_icon=":team:")
...
#             background-image: linear-gradient(to right, #f0f2f6 0%, #f8f9fa 100%);
#         }
...
#         st.title("📋 GatherHub Group Management")
#         st.markdown("### 🚀 Project Submission Portal")
        
#         # Provide a subtle introduction
#         st.markdown("""
...
# def main():
#     st.set_page_config(
#         page_title="GatherHub Group Management", 
#         page_icon="📋", 
#         layout="centered",
